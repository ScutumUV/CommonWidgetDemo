...
import com.superc.common.widget.shimmerFacebook.Shimmer
import com.superc.common.widget.shimmerFacebook.ShimmerFrameLayout
import kotlinx.android.synthetic.main.activity_shimmer_view_facebook.*

class ShimmerViewFacebookTestActivity : Activity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_shimmer_view_facebook)
        ...
        presetButtons.forEach { it.setOnClickListener(this@ShimmerViewFacebookTestActivity) }
