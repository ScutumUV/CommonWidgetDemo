...
import com.superc.common.widget.qmui.span.QMUIAlignMiddleImageSpan;
import com.superc.common.widget.qmui.span.QMUIBlockSpaceSpan;
import com.superc.common.widget.qmui.span.QMUICustomTypefaceSpan;
import com.superc.common.widget.qmui.span.QMUIMarginImageSpan;
import com.superc.common.widget.qmui.util.QMUIDisplayHelper;
import com.superc.common.widget.qmui.util.QMUIDrawableHelper;
...
public class QDSpanFragment extends BaseFragment {
    ...
    static {
        try {
            Typeface tmpRmb = Typeface.createFromAsset(MyApplication.getContext().getAssets(),
                    "fonts/iconfont.ttf");
